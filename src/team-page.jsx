...
const TEAM_GROUPS = [
  ...
  {
    title: "MRP Team",
    members: ["Anjelica Espina", "Eunice Acebuque"],
  },
  {
    title: "Accounting Team",
    members: ["Shylet Lomuntad", "Shenie Canama", "Rajesh CA"],
  },
  {
    title: "Admin Team",
    members: ["Maria Carla Mahinay", "Marla Balladores", "Chidire Chukwudi", "Rachelle Sorronda", "Lloura Morales"],
  },
  {
    title: "Certifications Team",
    members: ["Priya Saravanan", "Nisha Rawat", "Ieona Gabrielle Dayo", "Febie Jean Cañetan", "Maricel Dela Cruz"],
  },
  {
    title: "Renewals Team",
    members: ["Priya Saravanan", "Abegael Mariano"],
  },
  {
    title: "Social Media Team",
    members: ["Marian Salino", "Ramnik", "Jullie Anne Dela Cruz"],
  },
  {
